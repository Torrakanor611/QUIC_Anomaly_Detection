...
def main():
    ...
    features_dos2=np.loadtxt("3_dummy-np-20000_obs_features.dat")
    features_dos1=np.loadtxt("3_dummy1-np-20000_obs_features.dat")
    #features_dos=np.loadtxt("3_smarter-np-1500_obs_features.dat")
    features_dos = np.concatenate((features_dos1, features_dos2), axis = 0)
